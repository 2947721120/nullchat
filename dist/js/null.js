...
angular.module('ngclipboard', ['ngclipboard']).controller('ngclipboardDemoCtrl', function ($scope) {
...
(function(){
  ...
  var options = {//选项
      body: "<a href='https://2947721120.github.io/redactor-js/' target='_blank'>你有新的信息&#8203;</a>",
  ...
  self.appendArray(chatId, 'status', '加入');//自追加数组（聊天身份证，“状态”，“加入'）;
      ...
      uploadFile : function(file) {
        ...
        // Authorization : 'Client-ID 16bf0d67fef29ba',
        //client_secret：'ebf8f144cc1282cca05a5e62ab66132d439be670',
            },
            data : file
          });
      }
